...
def t0():
    ...
    for (i,q) in zip(df_u,df_c):
        ...
        proxies = {'https': "http://scraperapi:3904bd3abf3f1b5b961fb165a9ca932a@proxy-server.scraperapi.com:8001"}
        r = requests.get(i, proxies=proxies,allow_redirects=False, headers=headers).text
